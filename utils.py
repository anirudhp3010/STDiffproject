#!/usr/bin/env python3
# @brief:    plot the relation between the number of using diff images and the IOU results
# @author    Xieyuanli Chen    [xieyuanli.chen@igg.uni-bonn.de]
...
def range_projection(
    current_vertex, fov_up=3.0, fov_down=-25.0, proj_H=64, proj_W=900, max_range=85
):
...
class projection:
    ...
    def get_masked_range_view(self, output,mask):
        ...
        masked_range_view = output.clone()
